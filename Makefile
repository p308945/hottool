...
hotfix: crossprocess.o find_sym_addr.o hook.o hotfix.o
	g++ hotfix.o crossprocess.o find_sym_addr.o hook.o -g -Wl,-export-dynamic -o hotfix

hotfind: crossprocess.o find_sym_addr.o hook.o hotfind.o
	g++ hotfind.o crossprocess.o find_sym_addr.o hook.o -g -Wl,-export-dynamic -o hotfind
